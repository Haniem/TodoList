      ...
      <div class="panel-body">
       <form method="post" id="to_do_form">
        ...
        <div class="input-group">
         <input type="text" name="task_name" id="task_name" class="form-control input-lg" autocomplete="off" placeholder="enter task..." />
...
<script>
 ...
 $(document).ready(function(){
  ...
  $(document).on('submit', '#to_do_form', function(event){
   ...
   if($('#task_name').val() == '')
   {
    $('#message').html('<div class="alert alert-danger">Fill in the field</div>');
    return false;
   }
   else
   {
